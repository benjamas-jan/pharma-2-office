const steps = [
  ...
  {
    num: "03",
    title: "เภสัชกรยืนยันรายการ + แจ้งราคา",
    desc:
      "เภสัชกรตรวจรายการยาที่คุณต้องการ แจ้งราคาให้ตรวจสอบก่อนยืนยัน พร้อมข้อมูลจัดส่ง ทีมงานเตรียมยาและเอกสารใบกำกับภาษี",
  },
  {
    num: "04",
  ...
  },
  {
    ...
    desc:
      "เมื่อยาในตู้ใกล้หมด ทักกลับใน LINE OA — เภสัชกรดูประวัติ order เดิม และช่วยจัดของซ้ำให้ได้รวดเร็ว ไม่ต้องเริ่มใหม่",
  },
];
